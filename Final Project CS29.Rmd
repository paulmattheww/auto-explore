...
## `auto_explore.eda`: Interface to Semi-Automation
...
- <small>`auto_explore.featexp` - Copy as of April 2019 of the [`featexp`](https://github.com/abhayspawar/featexp) main package code with custom changes</small>
- <small>`auto_explore.apis` - Code that fetches data and machine learning models from various sources</small>
- <small>`auto_explore.notebooks` - Formatting code for inside a Jupyter Notebook REPL environment</small>
- <small>`auto_explore.stats` - Currently only houses `best_theoretical_distribution` but this will expand</small>
- <small>`auto_explore.datetime` - Houses code pertaining to time-series features (e.g. `make_calendars`)</small>
